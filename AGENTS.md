...
- First-party Anthropic: any current model works unchanged — override `EXTRACTOR_BASE_URL` to `https://api.anthropic.com` and `EXTRACTOR_MODEL` to e.g. `Codex-haiku-4-5`.
